// basically copied from https://github.com/keesschollaart81/vscode-home-assistant/blob/1c32ff348d4609d30fcbf41bc6cba91697f9cc3b/src/language-service/src/home-assistant/socket.ts
  ...
  function connect(
    ...
    const closeMessage = (ev: {
      ...
      if (ev && ev.code && ev.code !== 1000) {
        errorMessage =
          `WebSocket connection to Home Assistant closed with code ${ev.code} and reason ${ev.reason}`;
      }
